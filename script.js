...
function updateEngineTexts() {
  ...
  if (engineSelect?.options?.[0]) {
    engineSelect.options[0].textContent = "Mode rapide (Sync-up, 9 s max)";
  }
  ...
  if (engine === "veed") {
    ...
    engineRulesText.textContent =
      "Ajoute une vidéo et un audio. Sync-up : 9 secondes maximum.";
    engineDescription.textContent =
...
function updateAccountDisplay() {
  ...
  if (currentUser) {
    ...
    hintText.textContent =
      engine === "veed"
        ? "Compte personnel actif. VEED utilise ton solde premium."
        : "Compte personnel actif. Sync-up utilise ton solde standard.";
    return;
  }
  ...
  hintText.textContent =
    engine === "veed"
      ? "Mode test public actif. VEED utilise le solde premium public."
      : "Mode test public actif. Sync-up utilise le solde standard public.";
}
