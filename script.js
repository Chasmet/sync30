...
async function playVideoInsideApp(playUrl, downloadUrl, fileName) {
  try {
    ...
    if (hintText) {
      hintText.textContent = "Lecture chargée dans l’application. Tu peux regarder ici ou télécharger.";
    }
...
async function loadVideos() {
  ...
  try {
    ...
    allVideos.forEach((item) => {
      ...
      helper.textContent = "Regarde ici dans l’application, ou utilise Ouvrir en secours.";
