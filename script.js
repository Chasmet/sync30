...
generateBtn.addEventListener("click", async () => {
  ...
  try {
    const result = await uploadToBackend(videoFile, audioFile);
    ...
    hintText.textContent = `${serverMessage} Le vrai rendu lipsync sera branché à l’étape suivante.`;
  } catch (error) {
...
async function uploadToBackend(videoFile, audioFile) {
