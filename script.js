...
const KLING_API_URL = "https://sync30-kling-api.onrender.com";
  ...
  try {
    ...
    if (engine === "veed") {
      ...
      hintText.textContent =
        "Mode VEED = qualité premium. Retour via URL vidéo.";
    } else {
      ...
      downloadBtn.download = "sync30-kling.mp4";
      hintText.textContent =
        "Mode Kling = lip-sync économique. Vidéo renvoyée directement.";
    }
...
function getSelectedEngine() {
  return engineSelect ? engineSelect.value : "kling";
}
